...
<body id="main">    
    <p>内容管理&gt;&gt;查看文档列表&gt;&gt;<strong id="title">{$title}</strong></p>
    ...
    {if $show}
        <table cellspacing="0">
            ...
            <tr>
                ...
                <td>{@value->count}</td>
                <td>{@value->date}</td>
                <td><a href="content.inc.php?action=update&id={@value->id}">修改</a> | <a href="content.inc.php?action=delete&id={@value->id}" onclick="return confirm('你真的要删除该文档吗?')?true:false">删除</a></td>
