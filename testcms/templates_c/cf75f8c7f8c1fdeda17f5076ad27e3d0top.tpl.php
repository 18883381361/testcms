...
<body id="top">
    ...
    <p>
	您好，<strong><?php echo $this->vars['admin_name']?></strong> [ <?php echo $this->vars['level_name']?> ] [ <a href="../" target="_blank">去首页</a> ] [ <a href="admin_login.php?action=logout" target="_parent">退出</a> ]
    </p>
</body>
</html>